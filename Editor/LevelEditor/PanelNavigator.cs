...
namespace VahTyah
{
    ...
    public class PanelNavigator
    {
        ...
        private void DrawContent(Rect contentRect)
        {
            ...
            Rect viewRect = new Rect(contentRect.x, contentRect.y, contentRect.width, contentRect.height);
            LayerDrawingSystem.DrawLayers(viewRect, contentBackground.backgroundConfig);
